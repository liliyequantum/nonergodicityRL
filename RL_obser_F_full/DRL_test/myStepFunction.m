...
NextObs = [fullFidelity]; % fullFidelity
...
if LoggedSignals.num_steps == trainConstants.n_steps
    ...
    saveas(gcf,[data_dirname,'/',DRL_dirname,'_picture/half_EntropyStep_test.png'])
    close(f)
    save([data_dirname,'/',DRL_dirname,'_picture_data/half_EntropyStep_test.mat'],...
         'halfEntropy_steps')
    ...
    close(f)     
    save([data_dirname,'/',DRL_dirname,'_picture_data/full_fidelityStep_test.mat'], ...
       'fullFidelity_steps')
