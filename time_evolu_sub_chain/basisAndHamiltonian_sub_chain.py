...
def subChainBasisIndex2Pattern(numSubChain):
    subPattern = []
    for i in range(0,2**numSubChain,1): # sub chain basis for up or down
    ...
    for i in range(len(subPattern)):
        for j in range(len(subPattern)):
            Index2Pattern.append(subPattern[i]+subPattern[j]) # sub chain basis
...
numAChain = 4#int(numLattice/2) # partial fidelity, entropy
...
# check basis number for up and down chains
...
#check basis number for the half chain
...
# check basis number for A and B sub chains
...
# print('upChain',upChainIndex2Pattern[upChain_row[10]])
# print('downChain',downChainIndex2Pattern[downChain_col[10]])
# print('subAChain',subAChainIndex2Pattern[subAChain_row[10]])
# print('subBChain',subBChainIndex2Pattern[subBChain_col[10]])

# # test index map  
# upChainIndex_row = upChain_row[9]
# downChainIndex_col = downChain_col[9]
# [subAChainIndex_row, subBChainIndex_col] = mapSpinChain2subChain(upChainIndex_row,downChainIndex_col,numAChain,numBChain,upChainIndex2Pattern,\
#     downChainIndex2Pattern,subAChainPattern2Index,subBChainPattern2Index)  
    
# print('upChain',upChainIndex2Pattern[upChainIndex_row])
# print('downChain',downChainIndex2Pattern[downChainIndex_col])
# print('subAChain',subAChainIndex2Pattern[subAChainIndex_row])
# print('subBChain',subBChainIndex2Pattern[subBChainIndex_col])
...
'subAChainIndex2Pattern' : subAChainIndex2Pattern,'subBChainIndex2Pattern' : subBChainIndex2Pattern,\
