...
maxNumCompThreads(1);
numLattice = 10;
load(['./numLattice_',num2str(numLattice),'_numAChain_4_numUp_',num2str(numLattice/2),...
...
Mpsi_subChain = zeros(numAChainBasis,numBChainBasis); % each run reinitial for entropy
